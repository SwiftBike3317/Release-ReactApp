...
import { connectWallet, getCurrentWalletConnected, getVestingData, sendRelease } from "./utils/interact";
...
const Release = (props) => {
    ...
    if (window.ethereum) {
      ...
      window.ethereum.on("chainChanged", (chainId) => {
        if (chainId != null && chainId == 0x38 ) {
          ...
          setStatus("Change your network to Binance Smart Chain. Chain id should be 0x38")
        }
      })
    } else {
      setStatus(
  ...
  const initComponents = () => {
    ...
    var pool_address = '0x3ccaD1a87f5DdCD7Af315D64006E2E9b4Dd7e807'
  ...
  return (
    ...
    <button> ETH </button>
      ...
      <br></br>
      <h1 id="title">Release App BSC</h1>
      <p>
