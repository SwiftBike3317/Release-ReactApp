    ...
    if (window.ethereum) {
        try {
            ...
            if (chainId != 0x38 || chainId != 0x1) {
                status = "Change your network to Ethereum Mainnet. Chain id should be 0x1"
            }
            const obj = {
                status: status,
...
export const getVestingData = async () => {
    ...
    var availableAmount = await window.vesting.methods.releasableAmount('0xd373576a9e738f37dc6882328358ff69c4caf4c6').call()
...
export const sendRelease = async () => {
    try {
        ...
        const transactionParams = {
            ...
            data: window.vesting.methods.release('0xd373576a9e738f37dc6882328358ff69c4caf4c6').encodeABI()
        }
        ...
        return {
            succes: true,
            status: "Check transaction on https://etherscan.io/tx/" + txHash
        }
